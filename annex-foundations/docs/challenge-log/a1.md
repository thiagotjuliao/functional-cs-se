# Annex A1 — Conceptual Challenge Log

## Bitwise Arithmetic & Binary Representation

> Challenges 1 to 30. The annex numbers its own challenges from 1, independently
> of the blocks, because an annex belongs to no block — the same reason its tag
> carries no block prefix.
>
> Every number below was executed and verified before being written. This file
> is the evidence behind **§G, Oral Defence** of
> [A1's checklist](../checklist/a1.md).

[← Annex index](../challenge-log.md) · [A1's checklist](../checklist/a1.md)
...
It is the evidence behind **§G, Oral Defence** in [`checklist.md`](../checklist/a1.md).
...
[`checklist.md`](../checklist/a1.md). In summary: `iconst_1; ishr` against
...
[`checklist.md`](../checklist/a1.md) remains open on that count.
