...
> The acceptance contract for this annex entry alone. The annex track is
> optional and non-blocking, but its completion bar is identical to any
> other module: complete only when **every** box below is `[x]`, with
> every measured number written into this file.

[← Annex index](../checklist.md) · [A1's challenge log](../challenge-log/a1.md)
...
- [x] **Allocation.** `BitSet64` operations over 100,000 iterations, measured
      ...
      - If it is not zero, name what escaped and why an `opaque type` failed to
        ...
        **Avoidable (~1,176).** The fold accumulates into a `(BitSet64,
        ...
        [`challenge-log.md`](../challenge-log/a1.md): entry 17 (this `Tuple2`), entry
...
- [x] Work the post-module conceptual challenges (Step 4 of the routine) as a
      ...
      - All nine exercises have entries in [`challenge-log.md`](../challenge-log/a1.md).
...
The answers are recorded in [`challenge-log.md`](../challenge-log/a1.md), one entry
