# Block 1, Module 1 — JVM Semantics & Immutability Allocation Stress
...
[← Block 1 index](../checklist.md) · [Module 2](b1-m2.md) · [Module 1's challenge-log](../challenge-log/b1-m1.md)
...
- [x] The single permitted impurity is `AllocationProbe` / `Bench` reading the
      ...
      [`challenge-log.md`](../challenge-log/b1-m1.md), entry 4: it counts only the
...
- [x] Work the post-module conceptual challenges (Step 4 of the routine) as a
      ...
      - Fifteen challenges over three rounds, all recorded in
        [`challenge-log.md`](../challenge-log/b1-m1.md). Every one of the nine exercises
...
[`challenge-log.md`](../challenge-log/b1-m1.md#carried-over-from-the-removed-self-check),
